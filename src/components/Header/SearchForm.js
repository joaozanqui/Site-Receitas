...
const SearchForm = () => {
  ...
  return (
    <form className='search-form flex align-center form' onSubmit={(e) => handleSearchResult(e)}>
      <input type = "text" className='form-control-input text-dark-gray fs-15' placeholder='Digite o nome da receita ...' onChange={(e) => handleSearchTerm(e)} />
