  ...
  return (
    <div className='section-wrapper'>
      <div className='container'>
        <div className='breadcrumb text-white bg-black'>
        ...
        <div className='sc-title'>Informações da receita</div>
        <section className='sc-details bg-white'>
            ...
            <div className='details-intro'>
              ...
              <div className='py-4'>
                ...
                <div className='source flex align-center'>
                  <span className='fw-7'>Fonte: &nbsp;</span>
                  <a href = {meal.source}>
          ...
          <div className='details-body'>
            ...
            <div className='instructions my-4'>
              <h6 className='fs-16'>Instruções:</h6>
              <ul className='grid'>
                {
                  instructions?.map((instruction, idx) => (
                    <li key = {idx} className = "fs-14">
                      <AiOutlineCheckSquare size = {18} className = "li-icon" />
